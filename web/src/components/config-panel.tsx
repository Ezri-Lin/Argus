...
import {
  ...
  type LibraryDoc, type LibraryStream, type LibraryFeed,
} from "@/dashboard/api";
...
/** Segment: tab/selector button. Active state handled inline. */
const btnSegment = {
  ...btnBase,
  padding: "4px 10px",
  fontSize: 12,
...
function TreemapConfig({ domains, members, selectedDomain, onSelectDomain, onAddDomain, onDeleteDomain, onEditDomain, onAddMember, onDeleteMember, onEditMember, onScoreMember }: {
  domains: DomainItem[];
  members: MemberItem[];
...
function FeedConfig({ variant, sources, members, keywords, filterPrompt, library, onChangeVariant, onChangeKeywords, onChangeFilterPrompt, onAddSource, onDeleteSource, onEditSource }: {
  variant: string;
  sources: SourceItem[];
  members: MemberItem[];
  keywords: string;
