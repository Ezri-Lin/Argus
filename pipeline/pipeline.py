...
【输出】
{{"sentiment":0.0,"importance":0.0,"kind":"转载","need_search":false,"need_pro":false,"reason":"","short_label":"IPO路演中","impactWeight":20,"impactPersistenceDays":7,"impactConfidence":0.5,"impactRationale":"一句话说明持续影响"}}"""
        ...
        for item in items:
            ...
            try:
                ...
                results.append({
                    ...
                    "need_pro": 1 if need_pro else 0, "route_reason": reason,
                })
            except Exception as e:
